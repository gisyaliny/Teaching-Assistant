---
title: 'Sample Answer Lab01 : Data manipulation and `ggplot`'
author: "Yalin Yang"
date: "`r Sys.Date()`"
output:
  html_document:
...
str(flights_ym)
```
**It summarizes the grouped `tibble` based on lowest level group indices (i.e., days of each month), Therefore, records at the lowest level `aggregated` into the upper level of _month_. In this example all records are aggrated into the 12 months.**
