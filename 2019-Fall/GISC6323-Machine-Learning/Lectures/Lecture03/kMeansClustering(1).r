##
## Brett Landz, Machine Learning with R. Packt, 2019
## Chapter 9: Clustering with k-means
## Objective: Finding Teen Market Segments
##
rm(list=ls())
set.seed(2345)
setwd("E:\\Lectures2019\\GISC6323\\Lecture03")

## Data background: Social media use of 30,000 high school teens in 2006
